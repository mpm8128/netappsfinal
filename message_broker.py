...
if __name__ == "__main__":
	...
	parameters = pika.ConnectionParameters(virtual_host=rmq_params["vhost"], credentials=credentials)
	...
	channel.queue_bind(exchange=rmq_params["exchange"], queue="debug_queue", routing_key="#")
